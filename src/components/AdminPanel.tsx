...
export default function AdminPanel({ onUnauthorized }: AdminPanelProps) {
  ...
  const addArrayItem = (officeId: string, field: 'localFocus' | 'preferredBibleVerses') => {
    setOffices((prev) =>
      prev.map((office) =>
        office.id === officeId
          ? { ...office, [field]: [...office[field], ''], isDirty: true }
          : office
      )
    );
  };
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Edit director, focus areas, verses, tone, and signature for any office. Changes go live immediately.
          </p>
        </div>
      </div>
            ...
            >
              ...
              {office.isEditing && (
                <div className="border-t border-gray-200 px-6 py-6 space-y-6 bg-gray-50">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-3">Local Focus Areas</label>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-3">Preferred Bible Verses</label>
                    <div className="space-y-2.5">
                      {office.preferredBibleVerses.map((item, index) => (
                        <div key={index} className="flex gap-2">
                          <textarea
                            ...
                            placeholder="e.g., Matthew 25:35 — &quot;For I was a stranger and you welcomed me…&quot;"
                            rows={2}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Tone Notes</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Signature Block</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Local Context</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Audience Notes</label>
                    <textarea
